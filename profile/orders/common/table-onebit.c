...
uint_fast8_t table_unrank_onebit(uint_fast64_t rank, uint_fast8_t weight, uint_fast8_t bit)
{
	return !!(bitvecttable[bvt_offsets[weight] + rank] & (((uint_fast64_t)1)<<bit));
}
